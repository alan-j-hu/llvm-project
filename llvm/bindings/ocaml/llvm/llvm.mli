...
[@@ocaml.deprecated
  "pointer_type2 is an alias for pointer_type. Please use pointer_type."]
...
[@@ocaml.deprecated
  "qualified_pointer_type2 is an alias for qualified_pointer_type. Please use \
...
[@@ocaml.deprecated
  "const_gep2 is an alias of const_gep. Please use const_gep."]
...
[@@ocaml.deprecated
  "const_in_bounds_gep2 is an alias of const_gep. Please use \
   const_in_bounds_gep."]
...
[@@ocaml.deprecated
  "add_alias2 is an alias of add_alias. Please use add_alias."]
...
val build_invoke2 : lltype -> llvalue -> llvalue array -> llbasicblock ->
                    llbasicblock -> string -> llbuilder -> llvalue
[@@ocaml.deprecated
  "build_invoke2 is an alias of build_invoke. Please use build_invoke."]
...
[@@ocaml.deprecated
  "build_load2 is an alias of build_load. Please use build_load."]
...
val build_gep2 : lltype -> llvalue -> llvalue array -> string -> llbuilder ->
                      llvalue
[@@ocaml.deprecated
  "build_gep2 is an alias of build_gep. Please use build_gep."]
...
val build_in_bounds_gep2 : lltype -> llvalue -> llvalue array -> string ->
                               llbuilder -> llvalue
[@@ocaml.deprecated
  "build_in_bounds_gep2 is an alias of build_in_bounds_gep. Please use \
   build_in_bounds_gep."]
...
val build_struct_gep2 : lltype -> llvalue -> int -> string -> llbuilder ->
                           llvalue
[@@ocaml.deprecated
  "build_struct_gep2 is an alias of build_struct_gep. Please use \
   build_struct_gep."]
...
val build_call2 : lltype -> llvalue -> llvalue array -> string -> llbuilder ->
                       llvalue
[@@ocaml.deprecated
  "build_call2 is an alias of build_call. Please use build_call."]
...
val build_ptrdiff2 : lltype -> llvalue -> llvalue -> string -> llbuilder ->
                     llvalue
[@@ocaml.deprecated
  "build_ptrdiff2 is an alias of build_ptrdiff. Please use build_ptrdiff."]
